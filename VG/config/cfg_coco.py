...
use_coco_eval = False
# label_list=["Cardiomegaly", "Lung Opacity", "Edema", "Consolidation", "Pneumonia", "Atelectasis", "Pneumothorax", "Pleural Effusion"]
label_list = ['Atelectasis', 'Consolidation', 'Pneumothorax', 'Edema', 'Pleural Effusion', 'Pneumonia', 'Cardiomegaly', 'Lung Lesion', 'Fracture', 'Lung Opacity', 'Enlarged Cardiomediastinum']
