...
from CXRGen.annotator.uniformer.mmcv.utils import _BatchNorm, _InstanceNorm, build_from_cfg, is_list_of
from CXRGen.annotator.uniformer.mmcv.utils.ext_loader import check_ops_exist
...
class DefaultOptimizerConstructor:
    ...
    def add_params(self, params, module, prefix='', is_dcn_module=None):
        ...
        if check_ops_exist():
            from CXRGen.annotator.uniformer.mmcv.ops import DeformConv2d, ModulatedDeformConv2d
