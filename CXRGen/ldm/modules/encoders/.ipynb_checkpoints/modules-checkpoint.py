...
class FrozenBertEmbedder(AbstractEncoder):
    ...
    def __init__(self, version="emilyalsentzer/Bio_ClinicalBERT", device="cpu", max_length=110, freeze=True):
        super().__init__()
...
class FrozenCLIPT5BertEncoder(AbstractEncoder):
    def __init__(self, clip_version="openai/clip-vit-large-patch14", t5_version="google/t5-v1_1-xl", bert_version = "emilyalsentzer/Bio_ClinicalBERT", device="cpu",
